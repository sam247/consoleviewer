...
function BingIconSmall({ className }: { className?: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 50 50"
...
function SiteCardSourceBadges({
  ...
  return (
    <div className="mt-1 flex items-center gap-2">
      <span
        className="inline-flex items-center justify-center rounded border border-border p-0.5 opacity-70"
        aria-label={sourceEngine === "google" ? "Google" : "Bing"}
      >
        {sourceEngine === "google" ? <GoogleIconSmall /> : <BingIconSmall />}
      </span>
      <span
        className={cn(
    ...
    >
      ...
      <div className="pt-1 mb-4">
        ...
        <div className="mt-1.5 flex items-center gap-2 flex-wrap">
          <SiteCardSourceBadges sourceEngine={sourceEngine} bingConnected={metrics.bingConnected} />
        </div>
      </div>
